...
export const createZone = async (zoneData) => {
  const response = await instance.post("/warehouse/zones", zoneData)
  return response.data
}

export const deleteZone = async (zoneId) => {
  const response = await instance.delete(`/warehouse/zones/${zoneId}`)
  return response.data
}
...
export const createRack = async (zoneId, rackData) => {
  const response = await instance.post(`/warehouse/zones/${zoneId}/racks`, rackData)
  return response.data
}

export const deleteRack = async (zoneId, rackId) => {
  const response = await instance.delete(`/warehouse/zones/${zoneId}/racks/${rackId}`)
  return response.data
}
...
// Create bin
export const createBin = async (rackId, binData) => {
  const response = await instance.post(`/warehouse/racks/${rackId}/bins`, binData)
  return response.data
}
