...
export default function FilterDropdown({ label, filterType, value, onSave, onCancel, options = [], isActive = false }) {
        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    className={cn("gap-2 justify-between", isActive && "bg-primary text-primary-foreground")}
                >
                    {label}
