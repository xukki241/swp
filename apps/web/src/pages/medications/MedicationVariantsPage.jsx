    ...
    <AppLayout>
              ...
              <TableBody>
                {variants.map((v) => (
                  <TableRow key={v.id}>
                    ...
                    <TableCell>{v.isActive ? "Đang hoạt động" : "Ngừng"}</TableCell>
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        ...
        >
          ...
          <DialogHeader>
            <DialogTitle>
              {editingVar ? "Chỉnh sửa Biến thể" : "Thêm Biến thể"}
            </DialogTitle>
          </DialogHeader>
          ...
          >
            ...
            <Controller
              name="unitFactor"
              control={control}
              render={({ field }) => <Input {...field} placeholder="Hệ số" />}
            />
            <Controller
              name="barcode"
              control={control}
              render={({ field }) => <Input {...field} placeholder="Mã vạch" />}
            />
            <Controller
              name="sellPrice"
              control={control}
              render={({ field }) => (
                <Input {...field} placeholder="Giá bán" type="number" />
              )}
            />
            <div className="flex items-center gap-2">
              <Controller
